...
from .views import (
    ...
    UserAlertMarkAllReadView,
    UserAlertDeleteView,
    UserAlertDeleteAllView,
...
urlpatterns = [
    ...
    path('alerts/mark-all-read/', UserAlertMarkAllReadView.as_view(), name='user-alert-mark-all-read'),
    path('alerts/<int:id>/', UserAlertDeleteView.as_view(), name='user-alert-delete'),
    path('alerts/delete-all/', UserAlertDeleteAllView.as_view(), name='user-alert-delete-all'),
